...
func NewGoHTTPClient(host string, debug int, timeout time.Duration) *GoHTTPClient {
	return &GoHTTPClient{
		client : &http.Client{
...
func (w *GoHTTPClient) Do(q *Query, opts *HTTPClientDoOptions) (lag float64, err error) {
...
func  (w *GoHTTPClient) HostString() string {
	return w.HTTPClientCommon.HostString
}

func (w *GoHTTPClient) Ping() {
